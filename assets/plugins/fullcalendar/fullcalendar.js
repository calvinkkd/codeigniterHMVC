...
var View = fc.View = Class.extend({
	...
	function getViewSpec(requestedViewType) {
		...
		var hash = options.views || {}; // the `view` option object
		...
		while (viewType && !viewClass) {
			...
			processSpecInput(fcViews[viewType]); // $.fullCalendar.view, lower precedence
	...
	function zoomTo(newDate, viewType) {
		...
		if (!viewType || !isValidViewType(viewType)) { // a general view name, or "auto"
			...
			viewStr = header.getViewsWithButtons().join(' '); // space-separated string of all the view in the header
